  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="harga_beli" value="<?= $result['harga_beli']?>" name="harga_beli" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="stok" value="<?= $result['stok']?>" name="stok"  type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="min_stok" value="<?= $result['min_stok']?>" name="min_stok" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
